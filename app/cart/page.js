  ...
  const [carts, setCarts] = useState([
    {
      ...
      img: `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/store/items/1.png`,
      quantity: 2,
      price: 354.96,
    },
    {
      ...
      img: `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/store/items/2.png`,
      quantity: 1,
      price: 579.96,
    },
    {
      ...
      img: `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/store/items/3.png`,
      quantity: 1,
      price: 649.98,
      mainPrice: 1299.96,
    },
