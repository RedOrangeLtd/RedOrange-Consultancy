  ...
  return (
    <MoorkLayout>
      <PageBanner
        ...
        bgImg="https://html.bslthemes.com/moork/img/blog/0.png"
      />
          ...
          <div className="row justify-content-between align-items-end">
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    Sustainable Design: Beyond Aesthetics
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
              </Link>
            </div>
            <div className="col-xl-4 mil-mb-50">
            ...
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                <div className="mil-cover-frame mil-up">
                  <div className="mil-hover-frame">
                    <img
                      loading="lazy"
                      // src="img/blog/3.png"
                      src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/blog/3.png`}
                      alt="project"
                      data-value-1={1}
                      data-value-2="1.1"
                      className="mil-scale-img"
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    The Power of Materials: Innovation in Every Detail
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
              </Link>
            ...
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                <div className="mil-cover-frame mil-up">
                  <div className="mil-hover-frame">
                    <img
                      loading="lazy"
                      // src="img/blog/4.png"
                      src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/blog/4.png`}
                      alt="project"
                      data-value-1={1}
                      data-value-2="1.1"
                      className="mil-scale-img"
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    The Evolution of Residential Design: Fusing Styles
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
              </Link>
            ...
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                <div className="mil-cover-frame mil-up">
                  <div className="mil-hover-frame">
                    <img
                      loading="lazy"
                      // src="img/blog/5.png"
                      src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/blog/5.png`}
                      alt="project"
                      data-value-1={1}
                      data-value-2="1.1"
                      className="mil-scale-img"
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    Hotel Design: Creating Memorable Environments
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
              </Link>
            ...
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                <div className="mil-cover-frame mil-up">
                  <div className="mil-hover-frame">
                    <img
                      loading="lazy"
                      // src="img/blog/6.png"
                      src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/blog/6.png`}
                      alt="project"
                      data-value-1={1}
                      data-value-2="1.1"
                      className="mil-scale-img"
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    Exploring Cultural Architecture: Beyond the Walls
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
              </Link>
            ...
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                <div className="mil-cover-frame mil-up">
                  <div className="mil-hover-frame">
                    <img
                      loading="lazy"
                      // src="img/blog/7.png"
                      src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/blog/7.png`}
                      alt="project"
                      data-value-1={1}
                      data-value-2="1.1"
                      className="mil-scale-img"
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    Technological Innovation: Transforming Architectural Design
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
              </Link>
            ...
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                <div className="mil-cover-frame mil-up">
                  <div className="mil-hover-frame">
                    <img
                      loading="lazy"
                      // src="img/blog/8.png"
                      src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/blog/8.png`}
                      alt="project"
                      data-value-1={1}
                      data-value-2="1.1"
                      className="mil-scale-img"
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    Conversations with the Founder: Luca Dormunt
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
              </Link>
            ...
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    Commercial Design: Beyond Functionality
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
              </Link>
            ...
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                <div className="mil-cover-frame mil-up">
                  <div className="mil-hover-frame">
                    <img
                      loading="lazy"
                      // src="img/blog/10.png"
                      src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/blog/10.png`}
                      alt="project"
                      data-value-1={1}
                      data-value-2="1.1"
                      className="mil-scale-img"
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    Reflections on Functionality: Spaces that Inspire
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
              </Link>
            ...
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                <div className="mil-cover-frame mil-up">
                  <div className="mil-hover-frame">
                    <img
                      loading="lazy"
                      // src="img/blog/11.png"
                      src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/blog/11.png`}
                      alt="project"
                      data-value-1={1}
                      data-value-2="1.1"
                      className="mil-scale-img"
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    Architecture and Nature: Design in Harmony
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
              </Link>
            ...
            <div className="col-xl-4 mil-mb-50">
              <Link href="publication" className="mil-blog-card">
                <div className="mil-cover-frame mil-up">
                  <div className="mil-hover-frame">
                    <img
                      loading="lazy"
                      // src="img/blog/12.png"
                      src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}img/blog/12.png`}
                      alt="project"
                      data-value-1={1}
                      data-value-2="1.1"
                      className="mil-scale-img"
                ...
                <div className="mil-descr mil-up">
                  <h5 className="mil-mb-10">
                    Lights and Shadows in Design: Creating Atmospheric
                    Environments
                  </h5>
                  <p className="mil-text-16">22/11/2023</p>
                </div>
